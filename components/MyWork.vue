  ...
  <div>
    ...
    <section class="bg-white pt-7 pb-14">
      <div class="container px-8 mx-auto sm:px-12 lg:px-20">
        ...
        <div
          class="grid items-center justify-center grid-cols-12  gap-x-4"
        >
          <div
            class="flex items-center justify-center col-span-6 sm:col-span-4 md:col-span-3 xl:col-span-3"
          >
            <img
          ...
          >
            <img
              src="/images/companies/sidy-fr.png"
              alt="Hubspot"
              class="block object-cover h-12"
            />
          </div>
          <div
            class="flex items-center justify-center col-span-6 sm:col-span-4 md:col-span-3 xl:col-span-3"
