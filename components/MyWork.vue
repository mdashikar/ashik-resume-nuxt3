  ...
  <div>
    ...
    <section class="py-12 sm:py-16 bg-white">
      <div class="max-w-7xl px-10 mx-auto sm:text-center">
        ...
        <p class="mt-4 text-gray-500 text-base sm:text-xl lg:text-2xl">
          ...
          more?<br class="lg:hidden hidden sm:block" />
          <a href="mailto:contact@ashik.dev" class="text-indigo-600">
            Email me.</a
          >
          👇
        </p>
        ...
        >
          ...
          >
            ...
            <p class="font-bold mt-4">v4krk</p>
          ...
          >
            ...
            <p class="font-bold mt-4">Innovie</p>
          ...
          >
            ...
            <p class="font-bold mt-4">Rent Desh</p>
          ...
          >
            ...
            <p class="font-bold mt-4">Tasto Menu</p>
          ...
          >
            ...
            <p class="font-bold mt-4">Laadey</p>
          ...
          >
            ...
            <p class="font-bold mt-4">Sidy</p>
            <p class="mt2 text-sm text-gray-500">Transparent and simple management app for your property!</p>
          </div>
 
        </div>
        <a
          href="#_"
          class="px-6 py-3 sm:w-auto w-full text-center text-base font-medium inline-block rounded text-white hover:bg-indigo-600 bg-indigo-500"
          >View All</a
        >
      </div>
    </section>
    ...
    <section class="bg-white pt-7 pb-14">
      <div class="container px-8 mx-auto sm:px-12 lg:px-20">
        ...
        <div class="grid items-center justify-center grid-cols-12 gap-x-4">
          <div
            class="flex items-center justify-center col-span-6 sm:col-span-4 md:col-span-3 xl:col-span-2"
          >
            <img
              src="/images/companies/rootsoft.png"
              alt="Rootsoft"
          ...
          >
            <img
              src="/images/companies/innovie.jpg"
              alt="innoive"
              class="block object-contain h-9"
            />
          </div>
          ...
          >
            <img
              src="/images/companies/waseka.png"
              alt="waseka"
              class="block object-contain h-9"
            />
          </div>
          ...
          >
            <img
              src="/images/companies/v4krk.png"
              alt="v4krk"
              class="block object-contain h-9"
            />
          </div>
          ...
          >
            <img
              src="/images/companies/kahf-tech.png"
              alt="Kahftech"
              class="block object-contain h-9"
            />
          </div>
