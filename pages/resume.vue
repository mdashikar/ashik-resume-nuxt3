<template>
  <div class="bg-gray-50 min-h-screen">
    <Head>
      ...
      <Meta
        name="keywords"
        content="Md. Ashiqur Rahman resume, developer CV, JavaScript developer resume, Vue.js developer, React developer, Node.js developer, Senior Software Engineer, Full Stack Developer, TypeScript developer, Software Engineer resume, Web developer Bangladesh, Remote developer resume, Dorik engineer"
      />
      ...
      <Meta property="profile:first_name" content="Md. Ashiqur" />
      <Meta property="profile:last_name" content="Rahman" />
      <Meta property="profile:username" content="mdashikar" />
      <Meta property="profile:gender" content="male" />
      
      <Meta name="twitter:card" content="summary_large_image" />
      <Meta name="twitter:title" content="Resume | Md. Ashiqur Rahman - Senior Full Stack JavaScript Developer" />
      <Meta name="twitter:description" content="Professional resume detailing skills, experience and projects of Md. Ashiqur Rahman - Senior Software Engineer." />
      <Meta name="twitter:image" content="https://ashik.dev/images/ashik.jpg" />
      
      <Link rel="canonical" href="https://ashik.dev/resume" />
    </Head>

    <!-- Navigation Header -->
    <div class="bg-white shadow-sm">
      <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        <NuxtLink to="/" class="text-gray-800 hover:text-indigo-600 transition-colors flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M9.707 16.707a1 1 0 01-1.414 0l-6-6a1 1 0 010-1.414l6-6a1 1 0 011.414 1.414L5.414 9H17a1 1 0 110 2H5.414l4.293 4.293a1 1 0 010 1.414z" clip-rule="evenodd" />
          </svg>
          Back to Home
        </NuxtLink>
        <span class="text-gray-600 font-medium">Resume</span>
      </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-8">
      ...
      <div class="flex justify-between items-center mb-10">
        <div>
          <h1 class="text-3xl md:text-4xl font-bold text-gray-800">Md. Ashiqur Rahman</h1>
          <h2 class="text-xl text-gray-600 mt-2">Full Stack JavaScript Developer</h2>
          
          <div class="mt-4 flex flex-wrap items-center gap-4 text-sm text-gray-600">
            <a href="mailto:md.ashik.ar@gmail.com" class="flex items-center hover:text-indigo-600">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              md.ashik.ar@gmail.com
            </a>
            ...
            <a href="https://www.ashik.dev" target="_blank" class="flex items-center hover:text-indigo-600">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div class="mt-3 flex flex-wrap gap-3">
            <a href="https://linkedin.com/in/mdashikar" target="_blank" class="text-sm text-gray-600 hover:text-indigo-600 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
              linkedin.com/in/mdashikar
            </a>
            <a href="https://github.com/mdashikar" target="_blank" class="text-sm text-gray-600 hover:text-indigo-600 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
              ...
              github.com/mdashikar
            </a>
            <a href="https://stackoverflow.com/users/6001025/md-ashiqur-rahman" target="_blank" class="text-sm text-gray-600 hover:text-indigo-600 flex items-center">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="currentColor" viewBox="0 0 24 24">
      ...
      <!-- Experience Section -->
      <section class="mb-10 bg-white rounded-lg shadow-md p-6">
        <h3 class="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">Professional Experience</h3>
        ...
        <div class="space-y-8">
          ...
          <div>
            <div class="flex justify-between items-start mb-2">
              <div>
                <h4 class="text-lg font-medium text-gray-800">Senior Software Engineer</h4>
                <p class="text-gray-600">Dorik</p>
              </div>
          ...
          <div>
            <div class="flex justify-between items-start mb-2">
              <div>
                <h4 class="text-lg font-medium text-gray-800">Lead Front-end Developer</h4>
                <p class="text-gray-600">Relantin</p>
              </div>
              <div class="text-right">
                <span class="text-sm font-medium bg-gray-100 text-gray-800 px-2 py-1 rounded">11/2021 - 10/2022</span>
              </div>
            </div>
          ...
          <div>
            <div class="flex justify-between items-start mb-2">
              <div>
                <h4 class="text-lg font-medium text-gray-800">Front-end Developer</h4>
                <p class="text-gray-600">Rootsoft IT</p>
              </div>
              <div class="text-right">
                <span class="text-sm font-medium bg-gray-100 text-gray-800 px-2 py-1 rounded">02/2021 - 10/2021</span>
              </div>
            </div>
      ...
      <!-- Education Section -->
      <section class="mb-10 bg-white rounded-lg shadow-md p-6">
        <h3 class="text-xl font-semibold text-gray-800 mb-4 border-b pb-2">Education</h3>
        ...
        <div class="space-y-4">
          <div>
            ...
            <div class="mt-2">
              <p class="text-sm font-medium text-gray-700">Relevant Coursework:</p>
              <p class="text-sm text-gray-600">Computer Programming, Data Structures & Algorithms, OOP, Computer Architectures, OS, AI, Networking</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="border rounded-lg p-4">
            ...
            <p class="text-gray-600">Full Professional Proficiency</p>
          </div>
